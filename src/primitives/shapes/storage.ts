...
class StorageRenderer extends RichRenderer {
  protected buildStyle(): string {
    return `rounded=1;arcSize=20;whiteSpace=wrap;fontStyle=1;fontSize=${this.theme.fontSize};align=center;verticalAlign=top;spacingTop=2;fillColor=none;strokeColor=${this.theme.colorDark};fontColor=${this.theme.colorDark};collapsible=0;container=1;`;
  }
}
