...
class FileRenderer extends RichRenderer {
  protected buildStyle(): string {
    return `shape=note2;rounded=1;absoluteArcSize=1;arcSize=${RECT_ARC_SIZE};fontStyle=1;fontSize=${DEFAULT_FONT_SIZE};align=center;verticalAlign=top;spacingTop=2;fillColor=none;strokeColor=${COLOR_DARK};fontColor=${COLOR_DARK};whiteSpace=wrap;size=10;collapsible=0;container=1;`;
  }
}
