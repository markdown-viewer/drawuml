...
class ActionRenderer extends RichRenderer {
  protected buildStyle(): string {
    return `shape=singleArrow;arrowWidth=1;arrowSize=0.12;fontStyle=1;fontSize=${DEFAULT_FONT_SIZE};align=center;verticalAlign=middle;fillColor=none;strokeColor=${COLOR_DARK};fontColor=${COLOR_DARK};whiteSpace=wrap;collapsible=0;container=1;`;
  }
