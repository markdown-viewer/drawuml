...
class CloudRenderer extends RichRenderer {
  protected buildStyle(): string {
    return `shape=cloud;whiteSpace=wrap;size=0.5;fontStyle=1;fontSize=${this.theme.fontSize};align=center;verticalAlign=top;spacingTop=${Math.round(this.theme.spacingTop)};fillColor=none;strokeColor=${this.theme.colorDark};strokeWidth=${this.theme.strokeWidth};fontColor=${this.theme.colorDark};collapsible=0;container=1;`;
  }
  // Cloud arc border + corner radius inset
  protected shapePadding(): ShapePadding {
    return { left: this.theme.contentPad, right: this.theme.contentPad, top: this.theme.edgeGap, bottom: this.theme.edgeGap };
  }
