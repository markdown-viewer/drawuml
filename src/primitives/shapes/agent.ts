...
class AgentRenderer extends ShapeRenderer {
  protected buildStyle(): string {
    return `shape=mxgraph.basic.rect;fontStyle=1;fontSize=${DEFAULT_FONT_SIZE};align=center;verticalAlign=top;spacingTop=2;fillColor=none;strokeColor=${COLOR_DARK};fontColor=${COLOR_DARK};collapsible=0;container=1;`;
  }
}
