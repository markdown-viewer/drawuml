...
class CardRenderer extends RichRenderer {
  protected buildStyle(): string {
    ...
    if (!hasContent && !this.isCluster) {
      return `shape=mxgraph.basic.rect;fontSize=${DEFAULT_FONT_SIZE};align=center;verticalAlign=middle;fillColor=none;strokeColor=${COLOR_DARK};fontColor=${COLOR_DARK};collapsible=0;container=1;`;
    }
    return `shape=mxgraph.archimate.businessObject;size=20;fontStyle=1;fontSize=${DEFAULT_FONT_SIZE};align=center;verticalAlign=top;spacingTop=-2;fillColor=none;strokeColor=${COLOR_DARK};fontColor=${COLOR_DARK};collapsible=0;container=1;`;
  }
}
