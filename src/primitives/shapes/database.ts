...
class DatabaseRenderer extends RichRenderer {
  ...
  protected buildStyle(): string {
    return `shape=cylinder3;whiteSpace=wrap;size=${this.capHeight};fontStyle=1;fontSize=${this.theme.fontSize};align=center;verticalAlign=top;spacingTop=2;fillColor=none;strokeColor=${this.theme.colorDark};strokeWidth=${this.theme.strokeWidth};fontColor=${this.theme.colorDark};collapsible=0;container=1;`;
  }
