...
import { registerMindmapNodeRenderer } from './shapes/mindmap-node.ts';
import { registerMindmapBoxlessRenderer } from './shapes/mindmap-boxless.ts';
...
registerMindmapNodeRenderer();
registerMindmapBoxlessRenderer();
